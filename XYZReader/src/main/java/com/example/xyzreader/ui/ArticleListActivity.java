...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        Log.e("onLoadFinished", "cursor: "+cursor.getCount());
                ...
                public void onClick(View view) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        ...
                        ActivityOptionsCompat options = ActivityOptionsCompat.
                            makeSceneTransitionAnimation(ArticleListActivity.this,vh.thumbnailView,getString(R.string.activity_image_trans));
                        //ActivityOptionsCompat options = ActivityOptionsCompat.
                            //makeSceneTransitionAnimation(ArticleListActivity.this,pair1,pair2);
